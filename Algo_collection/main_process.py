...
def speech_2_text(audio_location):
	...
	data = open(audio_location,'rb').read()
...
def  decision_making(final_decision):
	if final_decision[0] == str(1):
		print "Hi There !! This is a cycling group where people plan trips & discuss about gears"
	elif final_decision[0] == str(2):
		print "The next tour is this Saturday at 17th December, please contact @dvigneshwer"
	elif final_decision[0] == str(3):
		print "Visit Hoodi Decathlon to buy this gear"
	else:
...
if __name__ == '__main__':
	...
	#Decision making
	decision_making(final_decision)
